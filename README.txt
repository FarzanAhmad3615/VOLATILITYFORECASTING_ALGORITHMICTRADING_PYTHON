...
How to Run
Ensure stock_data.csv is in the directory with a Date and Close column.
Install dependencies: pip install pandas numpy matplotlib statsmodels arch scikit-learn tensorflow.
Execute the script to generate the Model Comparison Plot.
Screenshot 2026-01-01 154140
